...
--  v14 Optimized - single shared loop, event-driven chams
...
-- Library.Notify passthrough is intentionally kept minimal
...
-- ==============================================================================
--  TARGET HUD  (v14 — v12 style, improved)
-- ==============================================================================
local THUD = {}
...
THUD.Container.BackgroundTransparency = 0.2
THUD.Container.Size                  = UDim2.new(0, 200, 0, 58)
THUD.Container.Position              = UDim2.new(0, -9999, 0, -9999)
THUD.Container.Visible               = false
THUD.Container.BorderSizePixel       = 0
THUD.Container.Parent                = THUD.Screen

local _cR = Instance.new("UICorner"); _cR.CornerRadius = UDim.new(0, 2); _cR.Parent = THUD.Container
local _cS = Instance.new("UIStroke"); _cS.Color = Color3.fromRGB(45, 45, 45); _cS.Transparency = 0.1; _cS.Thickness = 1; _cS.Parent = THUD.Container

THUD.Scale = Instance.new("UIScale")
THUD.Scale.Scale  = 1
THUD.Scale.Parent = THUD.Container

-- ── Square avatar (v12-style, sharp 2px corner) ────────────────────────────
THUD.Avatar = Instance.new("ImageLabel")
THUD.Avatar.Name             = "Avatar"
THUD.Avatar.BackgroundColor3 = Color3.fromRGB(18, 18, 18)
THUD.Avatar.Size             = UDim2.new(0, 36, 0, 36)
THUD.Avatar.Position         = UDim2.new(0, 8, 0.5, -18)
THUD.Avatar.Image            = ""
THUD.Avatar.BorderSizePixel  = 0
THUD.Avatar.Parent           = THUD.Container
local _avC = Instance.new("UICorner"); _avC.CornerRadius = UDim.new(0, 2); _avC.Parent = THUD.Avatar

-- HP-colored ring (UIStroke on Avatar, updates each frame)
THUD.AvatarRing = Instance.new("UIStroke")
THUD.AvatarRing.Color        = Color3.fromRGB(100, 220, 100)
THUD.AvatarRing.Thickness    = 1.5
THUD.AvatarRing.Transparency = 0
THUD.AvatarRing.Parent       = THUD.Avatar

-- ── Name row ──────────────────────────────────────────────────────────────
THUD.NameLbl = Instance.new("TextLabel")
THUD.NameLbl.Name                = "Name"
THUD.NameLbl.BackgroundTransparency = 1
THUD.NameLbl.Position            = UDim2.new(0, 54, 0, 6)
THUD.NameLbl.Size                = UDim2.new(1, -92, 0, 14)
THUD.NameLbl.Font                = Enum.Font.RobotoMono
...
THUD.NameLbl.TextTruncate        = Enum.TextTruncate.AtEnd
THUD.NameLbl.Parent              = THUD.Container

-- ── HP number (top-right, v12 style) ──────────────────────────────────────
THUD.HPText = Instance.new("TextLabel")
THUD.HPText.Name                = "HPText"
THUD.HPText.BackgroundTransparency = 1
THUD.HPText.Position            = UDim2.new(1, -36, 0, 4)
THUD.HPText.Size                = UDim2.new(0, 34, 0, 16)
THUD.HPText.Font                = Enum.Font.RobotoMono
THUD.HPText.Text                = "100"
THUD.HPText.TextColor3          = Color3.fromRGB(220, 220, 220)
THUD.HPText.TextSize            = 12
THUD.HPText.TextXAlignment      = Enum.TextXAlignment.Right
...
THUD.DistLbl.Position            = UDim2.new(0, 54, 0, 22)
THUD.DistLbl.Size                = UDim2.new(1, -62, 0, 12)
THUD.DistLbl.Font                = Enum.Font.RobotoMono
THUD.DistLbl.Text                = "WPN: NONE [0m]"
THUD.DistLbl.TextColor3          = Color3.fromRGB(160, 160, 160)
THUD.DistLbl.TextSize            = 10
THUD.DistLbl.TextXAlignment      = Enum.TextXAlignment.Left
THUD.DistLbl.TextTruncate        = Enum.TextTruncate.AtEnd
...
THUD.InfoLbl.Position            = UDim2.new(0, 54, 0, 35)
THUD.InfoLbl.Size                = UDim2.new(1, -62, 0, 10)
THUD.InfoLbl.Font                = Enum.Font.RobotoMono
THUD.InfoLbl.Text                = "0 st/s  |  visible"
THUD.InfoLbl.TextColor3          = Color3.fromRGB(100, 200, 100)
THUD.InfoLbl.TextSize            = 9
THUD.InfoLbl.TextXAlignment      = Enum.TextXAlignment.Left
THUD.InfoLbl.Parent              = THUD.Container

-- ── HP bar (thin 2px at bottom, v12 style) ────────────────────────────────
THUD.BarBG = Instance.new("Frame")
THUD.BarBG.Name             = "BarBG"
THUD.BarBG.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
THUD.BarBG.Position         = UDim2.new(0, 54, 0, 49)
THUD.BarBG.Size             = UDim2.new(1, -62, 0, 3)
THUD.BarBG.BorderSizePixel  = 0
THUD.BarBG.ClipsDescendants = true
        ...
        if cd then
            if cd.Hum.Health<=0 or not tar.Parent or not cd.Char or not cd.Char.Parent or not cd._wsValid then ClearTarget()
                ...
                if part then
                    ...
                    -- Team color with safe fallback (nil-safe)
                    local _rawTC = getgenv().SenseESP and getgenv().SenseESP.getTeamColor(tar)
                    local tC = (_rawTC and type(_rawTC) == "userdata") and _rawTC or C3N(0.51, 0.43, 1)
                    ...
                    if not onScreen then
                        ...
                        if not S.THUD.On then
                            ...
                            -- Slide-in animation
                            local animOffsetX = 30 * (1 - _thudAnimPct)
                            local cx = screenPos.X + S.THUD.OffX + animOffsetX
                            local cy = screenPos.Y + S.THUD.OffY
                            THUD.Container.Position = UDim2.new(0, cx, 0, cy)
                            
                            -- Row 1: name
                            THUD.NameLbl.Text = tar.DisplayName
                            
                            -- Row 2: weapon + distance (v12 style)
                            THUD.DistLbl.Text = "WPN: " .. wepName .. " [" .. tostring(dstFlr) .. "m]"
                            
                            -- Row 3: velocity + visibility
                            local velMag = 0
                            if cd.HRP then
                            ...
                            if lockVis then
                                THUD.InfoLbl.Text       = tostring(velMag) .. " st/s  |  visible"
                                THUD.InfoLbl.TextColor3 = Color3.fromRGB(100, 200, 100)
                            else
                                THUD.InfoLbl.Text       = tostring(velMag) .. " st/s  |  walled"
                                THUD.InfoLbl.TextColor3 = Color3.fromRGB(200, 80, 80)
                            end
                            
                            -- HP number (top-right)
                            THUD.HPText.Text = tostring(hpFlr)
                        end  -- closes: if not S.THUD.On
                        
                        -- Smooth bar fill
                        local hpPct = mClamp(hpFlr / mMax(1, maxHP), 0, 1)
                        _thudBarPct = _thudBarPct + (hpPct - _thudBarPct) * mClamp(dt * 8, 0, 1)
                        local smoothPct = _thudBarPct * _thudAnimPct
                        THUD.BarFill.Size = UDim2.new(smoothPct, 0, 1, 0)
                        
                        -- HP gradient applied to bar fill + avatar ring
                        local barCol = HPC(hpPct)
                        THUD.BarFill.BackgroundColor3 = barCol
                        THUD.AvatarRing.Color         = barCol
                        THUD.HPText.TextColor3        = barCol
                    end
                end
            end
        end
...
local function TickHB(dt)
    ...
    if mc and mc.Hum and mc.HRP then
        ...
        -- Note: gravity is NOT reset here when fly/gravity-override are off;
        -- it is only restored explicitly when the user disables GravOn or Fly via UI toggles.
    end
...
local Window = Library:CreateWindow({
    Title = "KAIM v14",
    Footer = "v14 | github.com/sswird/kaim",
    Icon = 95816097006870,
    NotifySide = "Right",
...
local KaimWatermark = Library:AddDraggableLabel("KAIM v14 | FPS: 0 | Ping: 0ms")
...
ThemeManager:SetFolder("KAIM_v14")
SaveManager:SetFolder("KAIM_v14/configs")
...
Conns[#Conns+1] = RS.Heartbeat:Connect(function()
    ...
    if now - lastUIRefresh >= 0.5 then
        ...
        KaimWatermark:SetText("KAIM v14 | FPS: " .. tostring(fps) .. " | Ping: " .. mFloor(ping) .. "ms" .. _lockStr)
        lastUIRefresh = now
    end
end)
...
_env.KAIM_UNLOAD = function()
    ...
    pcall(function() CH_L:Remove(); CH_R:Remove(); CH_T:Remove(); CH_B:Remove(); CH_D:Remove() end)
    -- Destroy ScreenGui instances
    ...
    pcall(function() if THUD.Screen then THUD.Screen:Destroy(); THUD.Screen=nil end end)
...
-- ==============================================================================
Library:Notify({Title="KAIM Obsidian v14", Description="Loaded - Obsidian Edition", Time=4})
